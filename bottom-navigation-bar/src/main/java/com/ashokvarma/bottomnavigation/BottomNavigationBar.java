...
//            mActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbActiveColor, Utils.fetchContextColor(context, R.attr.colorAccent));
            mActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbActiveColor, Utils.fetchContextColor(context, com.google.android.material.R.attr.colorAccent));
...
//            mActiveColor = Utils.fetchContextColor(context, R.attr.colorAccent);
            mActiveColor = Utils.fetchContextColor(context, com.google.android.material.R.attr.colorAccent);
